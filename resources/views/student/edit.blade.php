...
@section('title','Edit Student ')
    ...
    <div class="form-group row">
       ...
       <div class="col-md-6">
           <input id="father_name" type="text" class="form-control{{ $errors->has('father_name') ? ' is-invalid' : '' }}" name="father_name" value="{{ $student->father_name }}" required autofocus>
   ...
   <!-- mother name field -->
    <div class="form-group row">
       ...
       <div class="col-md-6">
           <input id="mother_name" type="text" class="form-control{{ $errors->has('mother_name') ? ' is-invalid' : '' }}" name="mother_name" value="{{ $student->mother_Name }}" required autofocus>
   ...
   <!-- presdent address field -->
    <div class="form-group row">
       ...
       <div class="col-md-6">
           <input id="presdent_address" type="text" class="form-control{{ $errors->has('presdent_address') ? ' is-invalid' : '' }}" name="presdent_address" value="{{ $student->presdent_address }}" required autofocus>
   ...
   <!-- permanent address field -->
    <div class="form-group row">
       ...
       <div class="col-md-6">
           <input id="permanent_address" type="text" class="form-control{{ $errors->has('permanent_address') ? ' is-invalid' : '' }}" name="permanent_address" value="{{ $student->permanent_address }}" required autofocus>
   ...
   <!-- end of permanent address field -->
    <!-- phone number field -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone_number" type="tel" maxlength="11"  class="form-control{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" name="phone_number" value="{{ $student->phone_number }}" required autofocus>
     ...
     <!-- home number field -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="home_number" type="tel" maxlength="11"  class="form-control{{ $errors->has('home_number') ? ' is-invalid' : '' }}" name="home_number" value="{{ $student->home_number }}" required autofocus>
     ...
     <div class="form-group row">
        ...
        <div class="col-md-6">
            <select id="department" class="form-control{{ $errors->has('department') ? ' is-invalid' : '' }}" name="department" value="{{ $student->department_id }}" required autofocus>
    ...
    <div class="form-group row">
       ...
       <div class="col-md-6">
           <select id="classes"  class="form-control{{ $errors->has('classes') ? ' is-invalid' : '' }}" name="classes" value="{{ $student->classes_id }}" required autofocus>
            <option value="">Select One</option>
            @foreach ( $classes as $itemc )
            <option value="{{ $itemc->id }}"  {{ $student->department_id==$itemc->id?"selected": ""}}>{{ $itemc->title }}</option>
            @endforeach
        </select>
   ...
   <div class="form-group row">
      ...
      <div class="col-md-6">
          <input id="roll" type="text" class="form-control{{ $errors->has('roll') ? ' is-invalid' : '' }}" name="roll" value="{{ $student->roll }}" required autofocus>
  ...
  <!-- reg_id field -->
    <div class="form-group row">
       ...
       <div class="col-md-6">
           <input id="reg_id" type="text" class="form-control{{ $errors->has('reg_id') ? ' is-invalid' : '' }}" name="reg_id" value="{{ $student->reg_id }}" required autofocus readonly>
